				...
				var ajaxOptions = {
					...
					"success": function (data) {
						try { 
							$(content).html(data);
							proxy._hide();
							proxy._trigger("ajaxSuccess", { data: data, url: link ,content: content});
						}
						catch (e) { }
					},
					"error": function (e) {
						try { 
							proxy._hide();
							proxy._trigger("ajaxError", {data:{ "status": e.status, "responseText": e.responseText, "statusText": e.statusText },content: content,url: link}); 
							}
						catch (e) { }
					},
					"complete": function (e) {
