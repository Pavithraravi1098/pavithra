...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["./../common/ej.core","./../common/ej.data","./ej.waitingpopup","./ej.pivotgauge","./../datavisualization/ej.circulargauge","./ej.pivot.common"], fn) : fn();
})
(function () {
