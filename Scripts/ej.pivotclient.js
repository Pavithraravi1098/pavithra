    ...
    ej.widget("ejPivotClient", "ej.PivotClient", {
        ...
        _createControl: function () {
            ...
            if (oclientProxy.displayMode() != "chartonly") {
                this.element.find("#PivotGrid").ejPivotGrid({ locale: this.model.locale, customObject: this.model.customObject, enableRTL: this.model.enableRTL, isResponsive: this.model.isResponsive, drillSuccess: ej.proxy(this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode ? this._gridDrillSuccess : this._clientGridDrillSuccess, this), enableCollapseByDefault: true });
            ...
            if (oclientProxy.displayMode() != "gridonly") {
                this.element.find("#PivotChart").ejPivotChart({ locale: this.model.locale, customObject: this.model.customObject, enableRTL: this.model.enableRTL, canResize: this.model.isResponsive, drillSuccess: ej.proxy(this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode ? this._chartDrillSuccess : this._clientChartDrillSuccess, this), size: { height: this._chartHeight, width: this._chartWidth }, commonSeriesOptions: { type: this.model.chartType, tooltip: { visible: true } } });
        ...
        _keyPressDown: function (e) {
            ...
            else if ((e.which === 37 || e.which === 39 || e.which === 38 || e.which === 40) && this.element.find(".chartTypesDialog").length > 0) {
                e.preventDefault();
        ...
        _wireDialogEvent: function () {
            oclientProxy.element.find(".newReportImg, .addReportImg, .removeReportImg, .renameReportImg, .saveReportImg, .loadReportImg, .pvtBtn, .mdxImg,.colSortFilterImg, .rowSortFilterImg, .autoExecuteImg").on(ej.eventType.click, function (evt) {
                ...
                if (evt.target.innerHTML != oclientProxy._getLocalizedLabels("Cancel") && evt.target.innerHTML != oclientProxy._getLocalizedLabels("OK") && evt.target.parentElement.innerHTML != oclientProxy._getLocalizedLabels("Cancel") && evt.target.parentElement.innerHTML != oclientProxy._getLocalizedLabels("OK")) {
                    ...
                    if (evt.target.className.indexOf("loadReportImg") >= 0) {
                        ...
                        if (oclientProxy.model.operationalMode == "servermode") {
                            ...
                            var serializedCustomObject = JSON.stringify(oclientProxy.model.customObject);
                            oclientProxy.doAjaxPost("POST", oclientProxy.model.url + "/" + oclientProxy.model.serviceMethodSettings.fetchReportList, JSON.stringify({ "customObject": serializedCustomObject, operationalMode: oclientProxy.model.operationalMode, analysisMode: oclientProxy.model.analysisMode }), oclientProxy._fetchReportListSuccess);
                        }
                        else {
                            ...
                            if (oclientProxy.model.enableLocalStorage) {
                                ...
                                var serializedCustomObject = JSON.stringify(oclientProxy.model.customObject);
                                oclientProxy.doAjaxPost("POST", fetchReportSetting.url + "/" + oclientProxy.model.serviceMethodSettings.fetchReportList, JSON.stringify({ "customObject": serializedCustomObject, operationalMode: oclientProxy.model.operationalMode, analysisMode: oclientProxy.model.analysisMode, }), oclientProxy._fetchReportListSuccess);
                            }
                        }
                    }
            ...
            this.element.find(".excelExportImg, .wordExportImg, .pdfExportImg").click(function (e) {
                ...
                var exportSetting = { url: "", fileName: "PivotClient", exportMode: ej.PivotClient.ExportMode.JSON };
            ...
            this.element.find(".dialogOKBtn").on(ej.eventType.click, function (e) {
                ...
                if (loadDlgTitle == oclientProxy._getLocalizedLabels("LoadReport")) {
                    ...
                    if (selectedReport != "") {
                        ...
                        ej.Pivot._createErrorDialog(oclientProxy._getLocalizedLabels("LoadReportAlertMsg"), "Error", oclientProxy);
                        return false;
                    }
                }
        ...
        _unWireEvents: function () {
            $(this.element.find(".dialogCancelBtn, .dialogOKBtn, .newReportImg, .addReportImg, .removeReportImg, .renameReportImg, .pvtBtn, .removeSplitBtn, .unCheckAll, .checkAll, .removeMeasure, .toggleCollapseButton, .toggleExpandButton, .saveReportImg, .loadReportImg,.mdxImg,.maximizedView,.colSortFilterImg, .rowSortFilterImg, .chartTypesImg, .toggleaxisImg, .autoExecuteImg, .nextPage, .prevPage, .firstPage, .lastPage")).off(ej.eventType.click);
            $(this.element.find(".dialogCancelBtn, .dialogOKBtn, .newReportImg, .addReportImg, .removeReportImg, .renameReportImg, .pvtBtn, .removeSplitBtn, .unCheckAll, .checkAll, .removeMeasure, .toggleCollapseButton, .toggleExpandButton, .saveReportImg, .loadReportImg,.mdxImg,.maximizedView,.colSortFilterImg, .rowSortFilterImg, .chartTypesImg, .toggleaxisImg,.autoExecuteImg, .nextPage, .prevPage, .firstPage, .lastPage")).off('click');
        ...
        _filterElementClick: function (args) {
            ...
            if (!($(args.element).attr("id") == "labelClearFilter" || ($(args.element).attr("id") == "valueClearFilter"))) {
        ...
        _reportToolbar: function () {
            ...
            ej.buildTag("li.loadReportImg e-icon", "", {}).attr("aria-label", this._getLocalizedLabels("LoadReport")).attr({ "title": this._getLocalizedLabels("LoadReport"), tabindex: 0 })[0].outerHTML +
             (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap ? ej.buildTag("li.mdxImg e-icon", "", {}).attr("aria-label", this._getLocalizedLabels("MDXQuery")).attr({ "title": this._getLocalizedLabels("MDXQuery"), tabindex: 0 })[0].outerHTML : "") +
            ((this.model.enableDeferUpdate && (this.model.analysisMode != ej.Pivot.AnalysisMode.Pivot) && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode) ? (ej.buildTag("li.autoExecuteImg e-icon", "", {}).attr("aria-label", this._getLocalizedLabels("DeferUpdate")).attr({ "title": this._getLocalizedLabels("DeferUpdate"), tabindex: 0 })[0].outerHTML) : "") +
        ...
        _fetchReportListSuccess: function (reportNameList) {
            ...
            if (reportNameList.d != undefined)
                reportNameList = (reportNameList.d[0].Value || (!ej.isNullOrUndefined(reportNameList[0]) ? reportNameList[0].Value : ""));
            else
            ...
            if (this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode && (args_className == "SortFilterDlg" || args_className == "mdx")) {
                ...
                if (args_className.split(" ")[0] == "newReportImg") {
                    ...
                    if (args_innerHTML != oclientProxy._getLocalizedLabels("Measures")) {
                        ...
                        checkOption = ej.buildTag("div.checkOptions", checkAll + unCheckAll, { "height": "19px", margin: (!isSlicerAxis&&this.model.enableAdvancedFilter ? "10px 0px 0px 31px" : 0) })[0].outerHTML;
                    }
                    if (args_innerHTML == oclientProxy._getLocalizedLabels("Measures")) {
                    ...
                    var memberEditorDiv = ej.buildTag("div.memberEditorDiv", (this._selectedFieldName != "" && !isSlicerAxis && this.model.enableAdvancedFilter ? checkOption : "") + memberEditor)[0].outerHTML;
                    ...
                    if (this._selectedFieldName != "" && !isSlicerAxis && this.model.enableAdvancedFilter) {
                        ...
                        labelFilterTag = ej.buildTag("div.filterElementTag")[0].outerHTML;
                    ...
                    var innerDiv = ej.buildTag("div", (labelFilterTag != "" && !isSlicerAxis && this.model.enableAdvancedFilter ? (levelList + ej.buildTag("div.e-seperator", {}, { "padding": "2px" }, cancelBtn)[0].outerHTML + labelFilterTag + ej.buildTag("div.e-seperator", {}, { "padding": "2px" })[0].outerHTML ) : checkOption) + memberEditorDiv)[0].outerHTML;
