...
(function ($, ej, window, undefined) {
    ...
    ej.widget("ejScroller", "ej.Scroller", {
        ...
        _ensureScrollers: function () {
            ...
            if (this.content().length > 0) {
                ...
                if (this._hScroll || this._vScroll) {
                    ...
                    var ElementHeight = rect.height - (this["border_bottom"] + this["border_top"] + this["padding_bottom"] + this["padding_top"]);
                ...
                if (this.model.width > 0) {
                    ...
                    if (this.model.targetPane != null && $paneObject.length)
                        ...
                        if (this.content()[0].scrollWidth > this.model.width) return true;
                            ...
                            if ($(this.content()[0]).find('> *').length > 0) return $(this.content()[0]).find('> *')[0].scrollWidth > this.model.width;
                        return false;
                    }
                }
                return false;
        ...
        _setModel: function (option) {
            for (var prop in option) {
                if (prop === "enableRTL") {
                    ...
                    if (prop === "height") this._eleHeight = option[prop]; if (prop === "width") this._eleWidth = option[prop];
                    this.refresh();
                    break;
                }
            }
        ...
        scrollX: function (pixel, disableAnimation, animationSpeed, source, e) {
            ...
            if (this._trigger("scroll", { source: source || "custom", scrollData: this._hScrollbar ? this._hScrollbar._scrollData : null, scrollLeft: pixel, originalEvent: e })) return;
        },
