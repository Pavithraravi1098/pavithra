...
(function ($, ej, undefined) {
    ...
    ej.widget("ejDialog", "ej.Dialog", {
        ...
        _setLocaleCulture:function(localizedLabels){
            ...
            if(this.defaults.closeIconTooltip===this.model.closeIconTooltip)
                ...
                if (!ej.isNullOrUndefined(this._options)) {	
                 	 if (!ej.isNullOrUndefined(this._options.tooltip)) this.localizedLabels.tooltip = this._options.tooltip;  
                     if ((!ej.isNullOrUndefined(this._options.title))) this.localizedLabels.title = this._options.title;					 
				} 
        ...
        _tooltipText: function(data){
            ...
            if(this._dialogClose.hasClass('e-close'))
            ...
            this._ejDialog.find("div.e-resize-handle").ejResizable(
                {
                    ...
                    resize: function (event) {
                        ...
                        scrObj= proxy._ejDialog.closest(".e-dialog.e-js").data("ejDialog")
                        if(scrObj) scrObj._resetScroller();                        
                    },
        ...
        _reSizeHandler: function () {
            ...
            if (!this._minimize) this._centerPosition();
            parentObj = this._getParentObj();
            this._change = false;
        ...
        _pixelsWidthDimension: function (parentObj) {
            ...
            if ($(parentObj).outerHeight() <= this._ejDialog.outerHeight()) this._setHeight(parentObj);
            ...
            this._ejDialog.animate(effect, (this.model.enableAnimation ? Number(this.model.animation.show.duration) : 0), function () {
                if (proxy.model) {
                    ...
                    if (proxy.model.maxHeight || proxy.model.maxWidth)
                    {
                        ...
                        proxy._updateScroller(height, proxy._ejDialog.width() - 2);
                    }
                }
            });
