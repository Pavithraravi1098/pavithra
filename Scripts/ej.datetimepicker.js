...
(function ($, ej, undefined) {
    ...
    ej.widget("ejDateTimePicker", "ej.DateTimePicker", {
        ...
        _renderDropdown: function () {
            ...
            _today = ej.buildTag("div.e-dt-button e-dt-today", this._localizedLabels.buttonText.today).attr((this._isIE8) ? { 'unselectable': 'on' } : {});
            _now = ej.buildTag("div.e-dt-button e-dt-now", this._localizedLabels.buttonText.timeNow).attr((this._isIE8) ? { 'unselectable': 'on' } : {});
            _done = ej.buildTag("div.e-dt-button e-dt-done", this._localizedLabels.buttonText.done).attr((this._isIE8) ? { 'unselectable': 'on' } : {});
        ...
        _targetBlur: function () {
            ...
            var dateObj = ej.parseDate(this.element.val(), this.model.dateTimeFormat);
        ...
        _setInitialSelection: function () {
            ...
            activeItem = (index == elements.length) ? index : index + 1;
