...
(function ($, ej, undefined) {
    ...
    ej.widget("ejCheckBox", "ej.CheckBox", {
        ...
        _triggerChange: function () {
            var data = { isChecked: this._isChecked, checkState: this.model.checkState, isInteraction: false };
        ...
        _setModel: function (options) {
            for (var prop in options) {
                switch (prop) {
                    case "checked":
                        if (this.model.beforeChange) return this._triggerBeforeChange();
                    ...
                    case "checkState":
                        if (this.model.enableTriState) {
                            ...
                            if (this.model.change) {
                                if (!(this.checked() instanceof Array)) this._isChecked = this.model.checkState == "uncheck" ? false : true;
                                this._triggerChange();
                            }
                        }
                        break;
        ...
        _checkedHandler: function (evt) {
            ...
            var data = { isChecked: this._isChecked, checkState: this.model.checkState, isInteraction: true, event: evt };
            this._trigger("change", data);
            return true;
        },
