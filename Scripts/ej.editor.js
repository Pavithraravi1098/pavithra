...
(function ($, ej, undefined) {
    ...
    },
    {
        ...
        _renderControl: function () {
            ...
            this.element.attr({ 'role': 'spinbutton', 'aria-valuemin': this.model.minValue, 'aria-valuemax': this.model.maxValue, 'aria-valuenow': this.model.value, 'aria-live': 'assertive', "value": this.model.value });
        ...
        _restCultureInfo: function () {
            ...
            if (ctr != "numeric") format.pattern[1] = this._oldPositivePattern;            
        },
                ...
                if (this._textBox.value != "") {
                    ...
                    if (value < this.model.minValue) {
                        if (!this.model.enableStrictMode)
                            this._textBox.value = this._formatValue(this.model.minValue, "n", true)
                        else
                            this.isValidState = false
                    }
                    else if (value > this.model.maxValue) {
                        if (!this.model.enableStrictMode)
                            this._textBox.value = this._formatValue(this.model.maxValue, "n", true);
                        else
                            this.isValidState = false;
                    }
