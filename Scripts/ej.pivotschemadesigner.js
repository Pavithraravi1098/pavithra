...
(function ($, ej, undefined) {
    ...
    ej.widget("ejPivotSchemaDesigner", "ej.PivotSchemaDesigner", {
        ...
        _unWireEvents: function () {
            ...
            this._off(this.element, "click", ".ascOrder, .descOrder", ej.proxy(this._sortField, this));
        ...
        _createDialog: function (title, treeViewData) {
            ...
            var currentHierarchy, levelInfo, sortState, seperator, groupDropDown = "", filterElementTag = "";
           ...
           if (isAdvancedFilter) {
            ...
            var dialogContent = ej.buildTag("div#EditorDiv.editorDiv", groupDropDown + filterElementTag + ej.buildTag("div", ej.buildTag("div.memberEditorDiv", ej.buildTag("div#editorTreeView.editorTreeView")[0].outerHTML)[0].outerHTML)[0].outerHTML)[0].outerHTML + "</br>",
