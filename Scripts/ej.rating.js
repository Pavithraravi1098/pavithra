...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["./../common/ej.core","./ej.tooltip"], fn) : fn();
})
(function () {
...
(function ($, ej, undefined) {
    ...
    ej.widget("ejRating", "ej.Rating", {
        ...
        _initialize: function () {
            ...
            this._validation();
            if (this.model.value == 1 && this.element[0].value != "")
        ...
        _MouseMoveHandler: function (e) {
            ...
            if (parseFloat(this.model.maxValue) >= parseFloat(this.toolTipValue)) {
