...
(function (DocumentEditorFeatures) {
    ...
    var ParagraphAdv = (function (_super) {
        ...
        ParagraphAdv.prototype.GetStartLineWidget = function (start, startElement, selectionStartIndex) {
            ...
            if (startInline == null) {
                ...
                return { "lineWidget": startElement.CurrentLineWidget, "lineIndex": selectionStartIndex, "startElement": startElement };
            }
        };
    ...
    var LayoutViewer = (function () {
        ...
        LayoutViewer.prototype.InitTouchEvents = function () {
            var viewer = this;
            if (navigator.userAgent.match("Edge") || navigator.userAgent.match("MSIE") || navigator.userAgent.match(".NET")) {
            ...
            else if (navigator.userAgent.match("Chrome") || navigator.userAgent.match("FireFox") || navigator.userAgent.match("Safari")) {
