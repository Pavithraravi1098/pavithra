...
(function ($, ej, undefined) {
    ...
    ej.widget("ejTab", "ej.Tab", {
                    ...
                    case "headerPosition":
                        {
                            ...
                            if (this.model.headerPosition == ej.Tab.Position.Left || this.model.headerPosition == ej.Tab.Position.Right) {
                                ...
                                if (this.model.height && this.model.enableTabScroll) {
                                    $(this.contentPanels).height(Number(this.model.height) - 2);
            ...
            if (this.model.enableTabScroll == true && this._tabContentsHeight() > this.items.height()) {
                ...
                if (this.model.enableRTL && (this.model.headerPosition == "top" || this.model.headerPosition == "bottom")) {
                    ...
                    if (this._tabContentsHeight() > Number(this.model.height)) {
                        ...
                        $(this.contentPanels).css({ "position": "absolute", "width": parseInt(this.element.width() - 1) + "px", "height": ej.getDimension(this.element, "height") + "px", "margin-left": "-" + ej.getDimension(this.element, "width") + "px", "border-right": "none" });
                        if (!this.model.enableRTL)
                            $(this.element).css("margin-left", ej.getDimension(this.element, "width") + "px");
        ...
        _executeForwardScrolling: function (args) {
            ...
            if (this.model.headerPosition == "top" || this.model.headerPosition == "bottom") {
                if (!this.model.enableRTL) {
                    ...
                    this.itemsContainer.css({ "clip": "rect(0px," + (ClipValue1 + 30) + "px,100px," + (ClipValue2 + 30) + "px)", "margin-left": "-" + (ClipValue2 + 30) + "px" });
                    this._rightScrollIcon.css("margin-right", (scrollValue - 30) + "px");
                    this._leftScrollIcon ? this._leftScrollIcon.css("margin-left", (ClipValue2 + 30) + "px") : "";

                    if ((this._leftScrollIcon && this._leftScrollIcon.css("margin-left")) && (Number(this._leftScrollIcon.css("margin-left").split("px")[0]) >= (this._tabContentsWidth() - ej.getDimension(this.element, "width")))) {
                    ...
                    this.itemsContainer.css({ "clip": "rect(0px," + (ClipValue1 - 30) + "px,100px," + (ClipValue2 - 30) + "px)", "margin-right": "-" + (-itemsMargin + 30) + "px" });
                    this._rightScrollIcon.css("margin-left", (scrollValue - 30) + "px");
                    this._leftScrollIcon ? this._leftScrollIcon.css("margin-right", (RightScroll + 30) + "px") : "";
                    if (this._leftScrollIcon && this._leftScrollIcon.css("margin-right") && (Number(this._leftScrollIcon.css("margin-right").split("px")[0])) >= (this._tabContentsWidth() - 40))
                        this._rightScrollIcon.css("display", "none")
                ...
                this.itemsContainer.css({ "clip": "rect(" + (ClipValue1 + 30) + "px, " + (this.itemsContainer.width() + 4) + "px," + (ClipValue2 + 30) + "px, 0px)", "margin-top": "-" + (-MarginTop + 30) + "px" });
                this._rightScrollIcon.css("margin-top", (scrollValue + 30) + "px");
                this._leftScrollIcon ? this._leftScrollIcon.css("margin-top", (RightTop + 30) + "px") : "";
                if (ClipValue2 > (this._tabContentsHeight() - 20)) {
                    ...
                    this._rightScrollIcon.css("margin-top", "-" + (this._tabContentsHeight() - (this._tabContentsHeight() - Number(this.model.height)) - 22) + "px");
                    this._rightScrollIcon.css("display", "none");
                }
            }
        },
        _executeBackwardScrolling: function (args) {
            ...
            if (this.model.headerPosition == "top" || this.model.headerPosition == "bottom") {
                if (!this.model.enableRTL) {
                    ...
                    this.itemsContainer.css({ "clip": "rect(0px," + (ClipValue1 - 30) + "px,100px," + (ClipValue2 - 30) + "px)", "margin-left": "-" + (ClipValue2 - 30) + "px" });
                    this._rightScrollIcon.css("margin-right", (scrollValue + 30) + "px");
                    this._leftScrollIcon ? this._leftScrollIcon.css("margin-left", (ClipValue2 - 35) + "px") : "";
                    if (ClipValue2 - 30 < 0) {
                    ...
                    if (ClipValue2 <= 30 && this._leftScrollIcon)
                    ...
                    this._rightScrollIcon.css("margin-left", (scrollValue + 30) + "px");
                    this._leftScrollIcon ? this._leftScrollIcon.css("margin-right", (RightScroll - 30) + "px") : "";
                    if (itemsMargin >= -30 && this._leftScrollIcon) {
                        this._leftScrollIcon.css("display", "none");
                    }
                }
            }
                ...
                var MarginTop = this.itemsContainer.css("margin-top") ? Number(this.itemsContainer.css("margin-top").split("px")[0]) : 0;
                this.itemsContainer.css({ "clip": "rect(" + (ClipValue1 - 30) + "px, " + this.itemsContainer.width() + "px," + (ClipValue2 - 30) + "px, 0px)", "margin-top": "-" + (-MarginTop - 30) + "px" });
                this._rightScrollIcon.css("margin-top", (scrollValue - 30) + "px").css("display", "block");
                this._leftScrollIcon.css("margin-top", (RightTop - 30) + "px");
        ...
        _removeBaseClass: function () {
            ...
            $(this.contentPanels).removeClass("e-content  e-content-item e-box");
            $(this.contentPanels).removeClass("e-content  e-content-item e-box e-content-bottom e-activetop e-activebottom e-active-content");
        ...
        showItem: function (index) {
            if ($.inArray(index, this.model.disabledItemIndex) < 0) {
                ...
                this._preTabIndex = this.selectedItemIndex();
                this.selectedItemIndex(index);
                if (this.selectedItemIndex() >= this.contentPanels.length) {
                    this.selectedItemIndex(0);
                    index = this.selectedItemIndex();
                }
                if (index >= 0 && !this.initialRender && true === this._onBeforeActive(index)) return false;
            ...
            if (this.model.enableTabScroll && this._tabContentsWidth() > (this.model.width || this.element.width()) && this.itemsContainer.find("li").length && (this.model.headerPosition == "top" || this.model.headerPosition == "bottom")) {
                if (!this.model.enableRTL) {
                    ...
                    else if ((itemPosition < 0) && (Number(this.itemsContainer.find("li.e-active").offset().left.toFixed(0)) + this.itemsContainer.find("li.e-active").width() > ej.getDimension(this.element, "width") || (Number(this.itemsContainer.find("li.e-active").offset().left.toFixed(0)) - this.itemsContainer.find("li.e-active").width() < 0))) {
                        this.itemsContainer.css("clip", "rect(0 ," + (ej.getDimension(this.element, "width")) + "px, 100px, 0px)").css("margin-left", "0px")
                        this._rightScrollIcon ? this._rightScrollIcon.css("margin-right", (this.itemsContainer.width() - ej.getDimension(this.element, "width") + 20) + "px").css("display", "block") : "";
        ...
        _unWireEvents: function () {
            this._off(this.items, this.model.events);
            this._off(this.element.find("div.e-close"), "click");
        ...
        _onBeforeActive: function (index) {
            if (this.model.beforeActive != null) {
                ...
                if (this.selectedItemIndex() == -1 && this.model.collapsible)
                    ...
                    data = { prevActiveHeader: this.items[this._preTabIndex], prevActiveIndex: this._preTabIndex, activeHeader: this.items[index], activeIndex: index, isInteraction: this._isInteraction };
