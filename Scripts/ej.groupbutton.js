...
(function ($, ej, undefined) {
    ...
    ej.widget("ejGroupButton", "ej.GroupButton", {
        ...
        _renderItems: function () {
            ...
            this.items = this.itemsContainer.children('li, div').addClass('e-grp-btn-item').attr({ "aria-selected": false, "aria-disabled": false });
        ...
        _setSkin: function (skin) {
            (this.model.cssClass != skin) && this.element.removeClass(this.model.cssClass).addClass(skin);
        },
