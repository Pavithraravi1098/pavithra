...
(function ($, ej, undefined) {
    ...
    ej.widget("ejColorPicker", "ej.ColorPicker", {
        ...
        _buttonContainer: function () {
            if (this.model.displayInline) return;
        ...
        _paletteGenerate: function (colors, columns) {
            ...
            for (color = 0; color < colors.length; color++) {
                if (color && color % columns == 0)
                    this._tag = ej.buildTag("div.e-row");
                this._td = ej.buildTag("div.e-item").attr({ 'role': 'gridcell', "aria-label": "#" + $.trim(colors[color]), "value": "#" + $.trim(colors[color]), "style": "background-color:" + "#" + $.trim(colors[color]) });
        ...
        _bindClickOperation: function (e) {
            ...
            SplitMenu = $("#" + proxy._presetContainer.attr('id')).ejMenu("instance");
        ...
        _recentColor: function (e) {
            ...
            var hexCode = e.target.attributes.value, value;
        ...
        _colorCodeValue: function (e) {
            ...
            if (this._keyPressFlag == 1) {
                ...
                if (!e.shiftKey && !e.ctrlKey && e.keyCode !== 27) this._inputTag.addClass('e-error');
            }
        },
        ...
        _HexToRGB: function (hex) {
            if (!ej.isNullOrUndefined(hex)) {
                ...
                value = ej.isNullOrUndefined(this.rgb) ? parseFloat(this._tempOpacity) / 100 : this.rgb.a;
