...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["./../common/ej.core","./../common/ej.data","./../common/ej.touch"], fn) : fn();
})
(function () {
    ...
    ej.widget("ejRotator", "ej.Rotator", {
        ...
        _setCaptionText: function (index) {
            if (this.model.showCaption) {
                ...
                this._caption.children().html(this.element.children('li').eq(indx).children('img').attr("title"));
            }
        },
        ...
        _wireTouchEvents: function () {
            ...
            else this._off(this._wrapper, "swiperight swipeleft swipedown swipeup", this._touchOperations);
        ...
        getIndex: function () {
            ...
            if (this.model.displayItemsCount > 1) {
                if (this.model.circularMode) {
                    index = Math.round(-Math.round(this.element.position()[this.displayCss]) / this._liSize);
                    index = index - this.model.displayItemsCount;
                    for (i = 0; i < this.model.displayItemsCount ; i++) {
