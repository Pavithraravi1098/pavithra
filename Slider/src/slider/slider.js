    ...
    var Slider = /** @class */ (function (_super) {
        ...
        Slider.prototype.sliderBarClick = function (evt) {
            ...
            if (evt.target === handle) {
                ...
                if (!ej2_base_1.EventHandler.add(this.element, 'click', this.sliderBarUp, this)) {
        ...
        Slider.prototype.destroy = function () {
            ...
            if (ej2_base_1.isBlazor() && this.isMaterialTooltip && !ej2_base_5.isNullOrUndefined(this.materialHandle)) {
